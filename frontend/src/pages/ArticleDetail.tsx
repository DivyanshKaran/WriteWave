...
const relatedArticles = [
  {
    id: 2,
    title: "Japanese Verb Conjugation Made Simple",
    excerpt: "Learn the basics of Japanese verb conjugation patterns.",
    author: { name: "Hiroshi Nakamura", avatar: "HN" },
    readTime: "6 min read",
    views: 890
  },
  {
    id: 3,
    title: "Understanding Japanese Sentence Structure",
    excerpt: "A beginner's guide to Japanese sentence patterns.",
    author: { name: "Sakura Kimura", avatar: "SK" },
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">@{articleData.author.username}</p>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold mb-2">{articleData.author.name}</h3>
                  <p className="text-muted-foreground mb-3">@{articleData.author.username}</p>
                  <p className="text-sm mb-4">{articleData.author.bio}</p>
                  <div className="flex items-center gap-4 text-sm text-muted-foreground">
                    <span>{articleData.author.followers.toLocaleString()} followers</span>
