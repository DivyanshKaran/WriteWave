...
export default function CreateArticle() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await articlesService.getPopularTags();
            ...
            <div className="lg:col-span-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Share your knowledge and insights with the Japanese learning
                    community
                  </CardDescription>
                </CardHeader>
                      ...
                      <div className="min-h-[400px] p-4 border rounded-md bg-muted/50">
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html: formatAndSanitizeContent(content),
                          }}
                        />
                      </div>
                    ) : (
...
`code snippet`"
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {isPreview
                        ? "Preview mode - click Edit to continue writing"
                ...
                <CardContent>
                  <div className="space-y-3 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Choose 3-5 relevant tags for better discoverability
                      </p>
                    </div>
                    <div>
