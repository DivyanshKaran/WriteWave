...
const sampleGroups = [
  { id: 'g1', name: 'JLPT N4 Sprint', members: 128, lastActivity: '3 new posts today', joined: false },
  { id: 'g2', name: 'Kanji 500 Club', members: 256, lastActivity: 'Last practice session 2h ago', joined: true },
  { id: 'g3', name: 'Handwriting Masters', members: 89, lastActivity: 'Planning Saturday meetup', joined: false },
  { id: 'g4', name: 'Beginner Writers', members: 342, lastActivity: 'Welcome new members!', joined: false },
];
